...
Once this is done, extract ShaderToggler in the same folder as ReSahde along the game exe. It should be something like `steamapps\common\StateOfDecay2\StateOfDecay2\Binaries\Win64`
...
<img src="/images/SOD2_01.jpg" alt="UUU v3 GUI" style="box-shadow: 3px 3px 3px gray;">
</div>
<div> </div>
