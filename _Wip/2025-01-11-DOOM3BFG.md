...
Then, head to `C:\Users\Olivier\Saved Games\id Software\RBDOOM 3 BFG\base` and create a new file called `myconfig.cfg`. Copy and paste the following block of text and save it.
