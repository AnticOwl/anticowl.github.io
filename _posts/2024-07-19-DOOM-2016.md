...
r_imageAtlasMaxAniso 16; vt_qualityLightmapRoundDenominator 1.0;r_chromaticAberration 0;vt_restart;
```
In the same file, copy and paste the commands below. These keybinds will allow you to use the internal free camera and have The Slayer available.
```
